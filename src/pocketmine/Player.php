...
class Player extends Human implements CommandSender, InventoryHolder, ChunkLoader, IPlayer
{
    ...
    protected function sendNextChunk()
    {
        ...
        $count = 0;
        $loadQueueKeys = array_keys($this->loadQueue);
        foreach ($loadQueueKeys as $index) {
    ...
    protected function doFirstSpawn()
    {
        ...
        $usedChunksKeys = array_keys($this->usedChunks);
        foreach ($usedChunksKeys as $index) {
            Level::getXZ($index, $chunkX, $chunkZ);
            $chunkEntities = $this->level->getChunkEntities($chunkX, $chunkZ);
    ...
    public function canInteract(Vector3 $pos, $maxDistance, $maxDiff = 10)
    {
