 ...
 *  |____/   \__|  \__,_| |_|     \__|  \___/  |_|   |____/   \___/   \__,_|  \__|
 * CODE BY 2662623485
 * 有啥想问的加我扣扣qwq
 * 这个代码好抽象，所以就优化了
 */
...
const VERSION = "1.0.0"; //will be set by CI to a git hash
const API_VERSION = "2.0.0";
const CODENAME = "东北土皇帝提拉诺斯魔改的";
const MINECRAFT_VERSION = "1.14.514";
const MINECRAFT_VERSION_NETWORK = "SAKANACITY大法好";
const GENISYS_API_VERSION = '1.19.810';
...
if (version_compare("7.0", PHP_VERSION) > 0) {
    echo "[炸了] You must use PHP >= 7.0" . PHP_EOL;
    echo "[炸了] Please use the installer provided on the homepage." . PHP_EOL;
    exit(1);
}

if (!extension_loaded("pthreads")) {
    echo "[炸了] Unable to find the pthreads extension." . PHP_EOL;
    echo "[炸了] Please use the installer provided on the homepage." . PHP_EOL;
    exit(1);
}
...
ThreadManager::init();
$server = new Server($autoloader, $logger, PATH, DATA, PLUGIN_PATH, $lang);
