...
namespace pocketmine\tile {
    ...
    class WindowHandler implements Listener
    {
        ...
        public function close (InventoryCloseEvent $event) {
            ...
            if(WindowsAPI::getPlayerWindow($player)) {
                WindowsAPI::removePlayerWindow($player);
            }
        }
        ...
        public function transaction(InventoryTransactionEvent $event): bool
        {
            ...
            $window = WindowsAPI::getPlayerWindow($player);
            if ($window) {
    ...
    class Window extends BaseInventory
    {
        ...
        public function onOpen(Player $who)
        {
            ...
            $this->process(function() use ($who, $inventory) {
                ...
                WindowsAPI::addPlayerWindow($who, $inventory);
        ...
        public function onClose(Player $who)
        {
            ...
            $customInventory = $who->customInventory;
            if($customInventory !== null && $customInventory === $this) {
                ...
                $this->process(function () use ($who, $inventory) {
                    ...
                    WindowsAPI::removePlayerWindow($who);
